...
namespace OathFramework.Data.StatParams
{
    ...
    public sealed class MaxRangeMult : StatParam
    {
        public override string LookupKey   => Lookup.MaxRangeMult.Key;
        public override ushort? DefaultID  => Lookup.MaxRangeMult.DefaultID;
        public override float DefaultValue => 1.0f;
        public override float MinValue     => 0.0f;
        public override string DropdownVal => "attack/max range";
        
        public static MaxRangeMult Instance { get; private set; }
        protected override void OnInitialize() => Instance = this;
